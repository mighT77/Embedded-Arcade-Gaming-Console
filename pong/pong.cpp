...
int p1_x = int(0.05 * screenWidth);
int p1_y = int(0.5 * screenHeight);
int p2_x = int(0.9 * screenWidth);
int p2_y = int(0.5 * screenHeight);


void setUpPong() {
    gfx.setRotation(0);
    gfx.fillRect(p1_x, p1_y, 15, 50, vga.rgb(0x80, 0x80, 0x80));  // Blue paddle
    gfx.fillRect(p2_x, p2_y, 15, 50, vga.rgb(0x80, 0x80, 0x80));  // Red paddle
    gfx.drawLine(screenWidth / 2, 0, screenWidth / 2, screenHeight, vga.rgb(0x80, 0x80, 0x80));
    gfx.fillRect(ballX, ballY, bwidth, bheight, vga.rgb(255, 255, 0));
    drawScoreboard();
}
...
void drawBall() {
    gfx.fillRect(ballX, ballY, bwidth, bheight, vga.rgb(0x80, 0x80, 0));
    gfx.drawLine(screenWidth / 2, 0, screenWidth / 2, screenHeight, vga.rgb(0x80, 0x80, 0x80));
}
